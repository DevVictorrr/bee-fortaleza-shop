  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <h1 className="mt-2 text-4xl font-black md:text-5xl">Todos os produtos</h1>
        <p className="mt-3 max-w-xl text-muted-foreground">Equipamentos oficiais Bee Delivery — sede Fortaleza.</p>
