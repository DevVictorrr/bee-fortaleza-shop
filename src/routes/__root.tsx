...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Bee Delivery Fortaleza is a website for selling Bee Delivery bags, inspired by iFood's design." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Bee Delivery Fortaleza is a website for selling Bee Delivery bags, inspired by iFood's design." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Bee Delivery Fortaleza is a website for selling Bee Delivery bags, inspired by iFood's design." },
