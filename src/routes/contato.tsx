    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto grid gap-10 px-4 py-20 lg:grid-cols-2">
        <div>
          ...
          <h1 className="mt-3 text-4xl font-black md:text-5xl">Atendimento sede Fortaleza</h1>
          ...
          <div className="mt-8 grid gap-3">
            {[
              ...
              <div key={t} className="flex items-center gap-4 rounded-2xl border border-border bg-card p-4">
        ...
        <form className="rounded-3xl border border-border bg-card p-8 space-y-4" onSubmit={(e) => e.preventDefault()}>
